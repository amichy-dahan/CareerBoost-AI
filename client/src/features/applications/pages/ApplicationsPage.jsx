...
const ApplicationsPage = () => {
  ...
  const { data, isLoading, reload } = useApplications(filters, page, pageSize);
  const handleExport = () => {
    // Mock CSV export
  ...
  return <>
    ...
    <div className="min-h-screen bg-background pt-16">
      ...
      <div className="container py-6 mx-0 px-[24px] my-0">
        ...
        {/* Pagination */}
        {data.total > pageSize && <div className="flex items-center justify-center gap-4 mt-8">
            ...
            <Button variant="outline" disabled={page >= Math.ceil(data.total / pageSize)} onClick={() => setPage(page + 1)}>
              Next
            </Button>
          </div>}
      </div>
