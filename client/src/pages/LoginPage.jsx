  ...
  return <div className="min-h-screen bg-background flex px-0 mx-0">
      ...
      <div className="w-1/2 flex flex-col justify-center px-8 py-0 lg:px-[30px]">
        ...
        <div className="max-w-md space-y-8">
          ...
          {/* LinkedIn Button */}
          <Button variant="outline" onClick={handleLinkedInLogin} className="w-full h-12 flex items-center justify-center gap-3 border-2 hover:border-[#0077B5] hover:bg-[#0077B5]/5 transition-all">
